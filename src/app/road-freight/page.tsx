...
const services = [
  {
    ...
    icon: Truck,
    description:
      "Fast and reliable customer delivery operations.",
  },
  {
    title: "Regional Distribution",
    icon: Map,
    description:
      "Multi-region transportation coverage and scheduling.",
  },
  {
    title: "Fleet Visibility",
    icon: Eye,
    description:
      "Real-time GPS tracking and operational insights.",
  },
  {
    title: "Driver Monitoring",
    icon: UserCircle,
    description:
      "Performance, safety, and compliance tracking.",
  },
];
    ...
    <main className="min-h-screen">
      <section className="container mx-auto px-6 py-24">
        ...
        <p className="max-w-3xl text-muted-foreground mb-12">
          End-to-end transportation with fleet visibility,
        ...
        <div className="mt-16 border rounded-xl p-8">
          ...
          <p className="text-muted-foreground">
            Track active vehicles, delivery progress,
            route efficiency, fuel consumption,
